...
public class TwoQCache<K, V> implements ITwoQ<K,V> {
    ...
    public TwoQCache(int maxSize) {
        ...
        this.mapOut = new LinkedHashSet<>();
        this.mapHot = new LinkedHashSet<>();
    }
     ...
     * {@link }, or replaced by a call to {@link}. The default
     ...
     *                 if the removal was caused by a {@link } or {@link }.
     * @param newValue the new value for {@code key}, if it exists. If non-null,
     *                 this removal was caused by a {@link }. Otherwise it was caused by
     *                 an eviction or a {@link }.
     */
     ...
     * thread calls {@link} while another is creating a value for the same
     * key.
     */
